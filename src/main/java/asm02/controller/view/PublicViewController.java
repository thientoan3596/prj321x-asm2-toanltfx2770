...
public class PublicViewController {
    ...
    public String job(
        ...
        if (authUser != null) {
            if (authUser.getRole().equals(eUserRole.JOB_SEEKER)) {
                model.addAttribute("appliedApplication", applicationService.findApplication(jobId, authUser.getId()).orElse(null));
    ...
    public String company(
        ...
        CompanyResponse company = companyService.findCompany(companyId).orElseThrow(() -> new EntityNotFoundException("Company [" + companyId + "] not found"));
    ...
    public ResponseEntity<Resource> downloadCV(
        ...
        Path filePath = Paths.get(servletContext.getRealPath("/resources/"), uploadDir, cvDir).resolve(pdfFileName).normalize();
        try {
